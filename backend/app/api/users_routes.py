...
def student_register(
    ...
    """Registrar un nuevo estudiante (solo administradores)"""
...
def teacher_register(
    ...
    """Registrar un nuevo profesor (solo administradores)"""
...
def get_student(
    ...
    """Obtener información de un estudiante (profesores y administradores)"""
...
def list_teachers(
    ...
    """Listar todos los profesores (solo administradores)"""
...
def get_teacher(
    ...
    """Obtener información de un profesor (solo administradores)"""
...
def update_teacher(
    ...
    """Actualizar información de un profesor (solo administradores)"""
